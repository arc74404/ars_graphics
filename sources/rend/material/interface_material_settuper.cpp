...
InterfaceMaterialSettupper::generateSets() const
{
    std::tuple<MaterialResources, std::vector<vk::UniqueDescriptorSet>> res;
...
// {
//     m_shader_params_buffer_info->buffer = *m_shader_params_buffer.get();
//     m_shader_params_buffer_info->offset = 0;
//     m_shader_params_buffer_info->range  =
//     m_shader_params_buffer->getByteSize();

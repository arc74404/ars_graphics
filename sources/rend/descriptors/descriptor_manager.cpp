...
//     result[1].count         = 1;
//     result[1].binding_index = settings::bindings::material_shader_binding +
//     1; result[1].stage         = vk::ShaderStageFlagBits::eFragment;
//     result[1].type          = vk::DescriptorType::eCombinedImageSampler;

//     // Binding 2: Metallic-Roughness map
//     result[2].count         = 1;
//     result[2].binding_index = settings::bindings::material_shader_binding +
//     2; result[2].stage         = vk::ShaderStageFlagBits::eFragment;
//     result[2].type          = vk::DescriptorType::eCombinedImageSampler;

//     // Binding 3: AO map
//     result[3].count         = 1;
//     result[3].binding_index = settings::bindings::material_shader_binding +
//     3; result[3].stage         = vk::ShaderStageFlagBits::eFragment;
//     result[3].type          = vk::DescriptorType::eCombinedImageSampler;

//     // Binding 4: Emissive map
//     result[4].count         = 1;
//     result[4].binding_index = settings::bindings::material_shader_binding +
//     4; result[4].stage         = vk::ShaderStageFlagBits::eFragment;
//     result[4].type          = vk::DescriptorType::eCombinedImageSampler;

//     // Binding 5: other data
//     result[5].count         = 1;
//     result[5].binding_index = settings::bindings::material_shader_binding +
//     5; result[5].stage         = vk::ShaderStageFlagBits::eFragment;

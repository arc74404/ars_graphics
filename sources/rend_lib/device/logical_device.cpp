...
LogicalDevice::LogicalDevice(const vk::PhysicalDevice& physical_device,
                             const QueueFamilyIndices& queue_family_indices)
{
    ...
    auto&& res = physical_device.createDeviceUnique(device_info);
    ...
    m_logical_device = std::move(res.value);
}
} // namespace ars_graphics
